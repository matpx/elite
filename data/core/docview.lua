...
function DocView:draw_line_body(idx, x, y)
	...
	if config.highlight_current_line and not self.doc:has_selection() and line == idx and core.active_view == self then
	...
	if
		...
		and (core.is_idle or self.blink_timer < config.blink_period / 2)
