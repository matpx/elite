...
--
--   global { runner = {
--     build = function() return io.popen("make"):close() end,
--     run   = function() system.exec("./myapp") end,
--     clean = function() os.remove("myapp") end,
--     test  = function() system.exec("make test") end,
--   } }
--
...
local function run_task(name)
  ...
  local ok, success = pcall(runner[name])
  if not ok then
    last_status = false
